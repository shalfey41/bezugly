...
export const NavList: FC<Props> = ({ className }) => (
  <nav>
    <ul className={classnames(style.navList, className)}>
      ...
      <li className={style.navListItem}>
        <a className={`${theme.link} ${style.navListItemLink}`} href="https://www.udemy.com/course/react-redux-2020/?referralCode=0C74053563423A398A3C" target="_blank">
          <span className={theme.linkUnderline}>Курс по реакту</span>
        </a>
      </li>
      <li className={style.navListItem}>
        <a className={`${theme.link} ${style.navListItemLink}`} href="https://t.me/sexy_frontend" target="_blank">
